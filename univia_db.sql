...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2026 a las 16:11:03
...
INSERT INTO `publicacion` (`id_publicacion`, `titulo`, `descripcion`, `tipo_recurso`, `tipo_acuerdo`, `fecha_publicacion`, `estado`, `dni_usuario`, `id_materia`, `id_archivo`) VALUES
(2, 'trabajo de ingenieria 2', 'este es el trabajo practico 0 de la materia ingeniería de software 2', 'guia', 'pago', '2026-04-22', 1, 45876789, 1, 2),
(3, 'tp1', 'dfggd', 'guia', 'pago', '2026-04-22', 1, 45876789, 1, 3),
(5, 'economia', 'practico de economia ', 'resumen', 'gratis', '2026-04-22', 1, 45876789, 5, 5);
